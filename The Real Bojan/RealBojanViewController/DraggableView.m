...
-(id)initWithFrame:(CGRect)frame withBojan:(Bojan *)bojan {
...
-(void)removeAnimated:(BOOL)animated onComplete:(void(^)(void))didComplete {
	CGPoint finishPoint = CGPointMake((int)[AppUtils random:2]==0?-600:600, self.center.y);
	[UIView animateWithDuration:0.3
					 animations:^{
						 self.center = finishPoint;
						 self.transform = CGAffineTransformMakeRotation(-1);
